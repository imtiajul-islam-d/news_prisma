  ...
  return (
    <header className="text-base lg:text-sm">
      ...
      <nav className="border-b">
        <ul className="flex items-center max-w-screen-xl px-4 mx-auto overflow-x-auto gap-x-3 lg:px-8">
            ...
            return (
              ...
              >
                <a
                  ...
                  className="block px-3 py-2 text-gray-700 duration-150 rounded-lg hover:text-gray-900 hover:bg-gray-100"
                >
                  {item.name}
                </a>
              </li>
